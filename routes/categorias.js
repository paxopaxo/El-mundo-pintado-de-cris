...
const { validarCampos, verificaJWT } = require('../middleweres')
const { crearCategoria, obtenerCategoria, actualizarCategoria, obtenerCategoriaPorId } = require('../controllers/categorias')
